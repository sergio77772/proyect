...
public class ContactActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.setContentView(R.layout.contacto);
		browser = (WebView) findViewById(R.id.webViewContacto);
		...
		browser.loadUrl("http://vt000269.ferozo.com/APPUCR/droidlogin/formulario.html");
