...
public class MapaActivity extends FragmentActivity {
	...
	private void addMarkers(GoogleMap mapa) {
		mapa.addMarker(new MarkerOptions()
				...
				.icon(BitmapDescriptorFactory
						.fromResource(R.drawable.ic_sanchez))
				.snippet("carteleria"));
		...
		mapa.addMarker(new MarkerOptions()
				...
				.icon(BitmapDescriptorFactory
						.fromResource(R.drawable.ic_sinlogos))
				.snippet("CIRCUITO 9"));
		...
		mapa.addMarker(new MarkerOptions()
				.position(new LatLng(-24.1838, -65.2991)).title("MAMANO RAUL")
				.icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_raul))
				.snippet("CIRCUITO 1"));

		mapa.addMarker(new MarkerOptions()
				.position(new LatLng(-24.1855, -65.2995)).title("MAMANO RAUL")
				.icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_raul))
				.snippet("CIRCUITO 1"));

		mapa.addMarker(new MarkerOptions()
				.position(new LatLng(-24.1855, -65.3041)).title("MAMANO RAUL")
				.icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_raul))
				.snippet("CIRCUITO 1"));
		...
		mapa.addMarker(new MarkerOptions()
				.position(new LatLng(-24.1925, -65.2907)).title("CHOUQUE IVAN")
		...
		mapa.addMarker(new MarkerOptions()
				...
				.icon(BitmapDescriptorFactory
						.fromResource(R.drawable.ic_lisandro))
				.snippet("CIRCUITO 8"));
	...
	public void cargarVista(GoogleMap mapa) {
		...
		CameraPosition camPos = new CameraPosition.Builder().target(jujuy) // Centramos
